...
public class OI {
    ...
    public OI() {
        ...
        rightTrigger.whileHeld(new ShiftLow());
	    
        // SmartDashboard Buttons
        SmartDashboard.putData("Autonomous", new Autonomous());
        SmartDashboard.putData("Rase Leg", new RaseLeg());
        SmartDashboard.putData("Kick", new Kick());
        SmartDashboard.putData("Ball Handeling Deafult", new BallHandelingDeafult());
    ...
    // END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTORS
        ...
        leftTrigger.whenReleased(new Kick());
        leftTrigger.whenPressed(new RaseLeg());
    }
